  ...
  return (
    ...
    >
      <div className="max-w-4xl w-full">
        {/* Header */}
        <div className="header-container flex flex-col lg:flex-row justify-between lg:items-center gap-x-2 gap-y-6 py-2">
          ...
          <div className="basis-2/3">
            <RadioGroupButtons
              ...
              RadioGroupClass={"w-full min-h-22 sm:min-h-9 sm:min-w-36"}
